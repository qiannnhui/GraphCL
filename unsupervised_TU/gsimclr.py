...
if __name__ == '__main__':
    ...
    global_jaccard_matrix = None
    tmp_loader = DataLoader(dataset_eval, batch_size=batch_size, shuffle=False)
    print('================')
    print('lr: {}'.format(lr))
    ...
    # for epoch in range(start_epoch, epochs + 1):
        ...
        if False:
            ...
            with torch.no_grad():
                ...
                sub_jaccard = global_jaccard_matrix[s_idx][:, s_idx] if global_jaccard_matrix is not None else sub_cos
