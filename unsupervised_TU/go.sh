...
for seed in 3
do
  # for DATASET in COLLAB DD REDDIT-BINARY IMDB-BINARY NCI1 #195:1
  # for DATASET in MUTAG ENZYMES MSRC-21 REDDIT-MULTI-5K NCI1 #249:1
  # for DATASET in MSRC_21 REDDIT-BINARY DD IMDB-BINARY NCI1 #249:1
  # for DATASET in NCI1
  for DATASET in REDDIT-MULTI-5K
  # for DATASET in PROTEINS REDDIT-MULTI-5K NCI1 # 249:0
