...
do
  for AUG in dnodes
  do
    # for MODE in cheated normal reweighted rm_FN rm_FP reweighted_l2 rm_FNs_by_ENs reweight_FNs_by_ENs reweight_FNs_by_RBO normal_TN_add_weight
    # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode reweight_FNs_by_ENs --log_interval 1 --epochs 20 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy 1-coverage --renormalization
    ...
    do
      ...
      do
          ...
          # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy boost_TNs --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 6.0
          CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy boost_TNs --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 9.0
          CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy 1-coverage --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 9.0
          # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy hybrid --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 15.0
          # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy boost_TNs --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 21.0
          # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --renormalization --tn_weight $TN_WEIGHT
          # CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --tn_weight $TN_WEIGHT
