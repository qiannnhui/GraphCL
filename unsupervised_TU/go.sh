  ...
  do
    ...
    do
      ...
      do
          ...
          CUDA_VISIBLE_DEVICES=$1 python gsimclr.py --DS $DS --lr 1e-4 --local --num-gc-layers 5 --aug $AUG --mode $MODE --log_interval 1 --epochs 200 --plot_kde --plot_theta_l2 --plot_anchor_aug_pair_theta_per_epoch --do_hn_analysis --reweight_strategy boost_TNs --renormalization --RBO_anchor --RBO_p $RBO_p --tn_weight 8.0
